...
var Estaciones = function Estaciones(req, res) {
  ...
  var options = {
    ...
    "path": "/opendata/api/valores/climatologicos/inventarioestaciones/todasestaciones"+config.apiKey,
    "headers": {
...
module.exports.Estaciones = Estaciones;